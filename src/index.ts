...
const program = new Command()
  ...
  .argument("<patterns...>", "Test file paths or glob patterns (e.g., tests/**/*.spec.md)")
  ...
  .option("--trunc", "Truncate long lines in output (default: off — lines wrap in the terminal)", false)
